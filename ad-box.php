...
class AdBoxWidget extends WP_Widget {
	...
	public function form($instance) {
        ...
        <p>
        	...
        	<input
            	type="checkbox"
                id="<?php echo $this->get_field_id('dev_sign'); ?>"
                name="<?php echo $this->get_field_name('dev_sign'); ?>"
                value="yes"
                <?php if($dev_sign=='yes') echo 'checked'; ?> />
            <label for="<?php echo $this->get_field_id('dev_sign'); ?>"> Remove Developer Signature from Bottom</label>
        </p>
       <?php
	}
	...
	public function widget($args, $instance) {
		...
		// Check if user wants to remove developer signature from ads
		$ad_sponsor = ($dev_sign == 'yes') ? '' : $ad_sponsor;
